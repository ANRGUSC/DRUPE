...
(1) Make the password a varaiable and configbased
(2) Make the home always run after the childs to avpid the timing issue
(3) fix the processing and logging bug
